...
//base url
String url =
    'https://admin.buzride.com/'; //please add '/' in the end of the url as 'yourwebsite.com/'
String mqttUrl = '149.102.147.132'; //enter only ip address as 12.345.678.90
int mqttPort = 1883;
String mapkey = 'AIzaSyBsIq8oVsVRlw7cr9EIMCQexxUvUznANak';
  ...
  client.updates!.listen((List<MqttReceivedMessage<MqttMessage?>>? c) {
    ...
    if (c[0].topic == 'trip_status_' + userDetails['id'].toString()) {
      if (jsonDecode(pt)["success_message"] == "no_driver_found") {
        ...
        audioPlayers.play(DeviceFileSource(audio));
        valueNotifierBook.incrementNotifier();
        client.disconnect();
